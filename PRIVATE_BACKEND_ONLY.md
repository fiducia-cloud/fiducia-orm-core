...
Executable ORM/database capability code in this repository is backend-only. Product schema authority remains in `fiducia-cloud/fiducia-interfaces`; shared ORESoftware interface/validator repositories provide validation and audit tooling only.
