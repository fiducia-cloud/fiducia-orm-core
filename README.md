...
Shared **SeaORM** entity/query crate for the `fiducia-cloud` organization.
...
org-wide policy in
[`fiducia-cloud/.github/SERVICE_AND_DATA_ARCHITECTURE.md`](https://github.com/fiducia-cloud/.github/blob/main/SERVICE_AND_DATA_ARCHITECTURE.md)
