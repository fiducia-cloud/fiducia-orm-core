...
A passing fixture proves this repository executes the fail-closed gate. It does not certify Fiducia product contracts or ORM projections. Those remain subject to the repository's reviewed authority and generation boundaries; any unexplained mismatch stops evaluation and blocks promotion.
