...
use fiducia_orm_core::{
    ...
    COMMERCIAL_SCHEMA, COMMERCIAL_SQL_GIT_BLOB_SHA1, COMMERCIAL_TABLE_COUNT, COMMERCIAL_TABLES,
...
fn every_sea_orm_model_is_reachable() {
    ...
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::organization_contact_roles::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::pre_interest_registrations::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::applications::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::application_versions::Model>();
    ...
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::support_plan_versions::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::sla_policies::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::sla_policy_versions::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::contract_templates::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::contract_template_versions::Model>();
    ...
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::quote_line_items::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::quote_contract_references::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::contract_acceptances::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::workflow_transition_rules::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::workflow_events::Model>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_sea_orm::idempotency_records::Model>();
...
fn every_diesel_model_is_reachable() {
    ...
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::OrganizationContactRole>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::PreInterestRegistration>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::Application>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::ApplicationVersion>();
    ...
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::SupportPlanVersion>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::SlaPolicy>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::SlaPolicyVersion>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::ContractTemplate>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::ContractTemplateVersion>();
    ...
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::QuoteContractReference>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::ContractAcceptance>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::WorkflowTransitionRule>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::WorkflowEvent>();
    let _ = TypeId::of::<fiducia_orm_core::generated::commercial_diesel::models::IdempotencyRecord>();
